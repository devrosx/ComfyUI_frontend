  ...
  <PopoverRoot :open @update:open="onOpenChange">
    ...
    <PopoverPortal>
      <PopoverContent
        ...
        :class="
          cn(
            'pointer-events-auto z-3000 max-h-(--reka-popover-content-available-height) max-w-(--reka-popover-content-available-width) overflow-auto rounded-lg border border-interface-stroke bg-interface-panel-surface text-base-foreground shadow-lg outline-none',
            className,
            contentClass
          )
        "
